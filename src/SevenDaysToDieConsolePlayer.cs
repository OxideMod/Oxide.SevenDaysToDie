...
namespace Oxide.Game.SevenDays
{
    ...
    /// </summary>
    public class SevenDaysConsolePlayer : IPlayer
    {
        #region Objects
        ...
        public void Message(string message, string prefix, params object[] args)
        {
            ...
            SdtdConsole.Instance.Output(prefix != null ? $"{prefix} {message}" : message);
        }
        ...
        {
            SdtdConsole.Instance.ExecuteSync($"{command} {string.Join(" ", Array.ConvertAll(args, x => x.ToString()))}", new ClientInfo());
        }
